#include "caffe/util/permutohedral_old.hpp"
...
/************************************************/
/***          PermutohedralOld Lattice           ***/
/************************************************/
PermutohedralOld::PermutohedralOld() 
...
void PermutohedralOld::init(const float* feature, int feature_size, int N) {
...
#ifdef SSE_PERMUTOHEDRAL
void PermutohedralOld::compute( __m128* out, const __m128* in, int value_size, int in_offset, int out_offset, int in_size, int out_size) const {
...
void PermutohedralOld::compute(float* out, const float* in, int value_size, int in_offset, int out_offset, int in_size, int out_size) const {
#ifdef SSE_PERMUTOHEDRAl
    if ( in_size == -1)  in_size = N_ -  in_offset;
    if (out_size == -1) out_size = N_ - out_offset;
