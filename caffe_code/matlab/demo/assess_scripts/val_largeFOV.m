...
model_dir = '/home/hszhao/research/caffe_sg/models/ResNet50/';
net_model = [model_dir 'deploy_sg.prototxt'];
net_weights = [model_dir 'jpshi_train_iter_70000.caffemodel'];
...
%open
save_png_folder = '/mnt/sdb1/hszhao/ResNet50_largeFOV/fc8topng_val_jpshi513_70000/';
